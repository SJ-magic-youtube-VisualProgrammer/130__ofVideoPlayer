...
void GUI_GLOBAL::setup(string GuiName, string FileName, float x, float y)
{
	...
	********************/
	Group_Video.setup("Video");
		Group_Video.add(Video_Button_Start.setup("Start", false));
		Group_Video.add(Video_Button_Stop.setup("Stop", false));
		Group_Video.add(Video_Button_TogglePause.setup("TogglePause", false));
